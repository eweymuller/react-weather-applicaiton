        ...
        <div className="row">
          <div className="col-7">
            ...
            <div className="row">
              ...
              <div className="col-3 light">
                <h6>
                  <span>{Math.round((props.data.tempLow * 9) / 5 + 32)}</span>°F
                </h6>
              </div>
              <div className="col-3 light">
                <h6>
                  <span>{Math.round((props.data.tempHigh * 9) / 5 + 32)}</span>
                  °F
                </h6>
              </div>
            </div>
          ...
          <div className="col-2">
            <div className="row light">
              <h6>
                <span>{Math.round(props.data.wind / 1.609)}</span>mph
              </h6>
            </div>
            <div className="row light">
              <h6>
            ...
            <div className="row light">
              <h6>
                <span>{Math.round((props.data.feel * 9) / 5 + 32)}</span>°F
              </h6>
            </div>
          </div>
        </div>
